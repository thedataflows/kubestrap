/*******************************************************************************
 * Slight alteration of github.com/xyproto/binary
*******************************************************************************/
...
func BinaryFileByName(filename string) (bool, error) {
...
func BinaryFile(file *os.File) (bool, error) {
	...
	if fileLength-24 >= 48 {
		...
		_, _ = file.Seek(middlePos, io.SeekStart)
